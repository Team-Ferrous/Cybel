...
Report ID: comparative_1773473506_3304bbfe
Generated: Sat Mar 14 01:31:46 2026
Candidate count: 1
...
- best_of_breed_path: /home/mike/Documents/Github/Anvil/.saguaro/comparative/reports/comparative_1773473506_3304bbfe.best_of_breed.json
- creation_ledger_path: /home/mike/Documents/Github/Anvil/.saguaro/comparative/reports/comparative_1773473506_3304bbfe.creation_ledger.json
- frontier_packets_path: /home/mike/Documents/Github/Anvil/.saguaro/comparative/reports/comparative_1773473506_3304bbfe.frontier_packets.json
- json_path: /home/mike/Documents/Github/Anvil/.saguaro/comparative/reports/comparative_1773473506_3304bbfe.json
- markdown_path: /home/mike/Documents/Github/Anvil/comparative_reports/comparative_1773473506_3304bbfe.md
- native_programs_path: /home/mike/Documents/Github/Anvil/.saguaro/comparative/reports/comparative_1773473506_3304bbfe.native_programs.json
- port_ledger_path: /home/mike/Documents/Github/Anvil/.saguaro/comparative/reports/comparative_1773473506_3304bbfe.port_ledger.json

## Telemetry

- aggregate_candidate_count: 79
- comparative_boot_ms: 33753.917
- comparative_frontier_acceptance_rate: 1.2
- comparative_program_count: 6
- compare_lock_wait_ms: 0.023
...
- per_candidate_compare_ms: [33254.856]
...
- target_signature_build_ms: 69.09
...
- counterfit/reporting/image.py -> core/artifacts/manager.py [reporting_analogue, native_rewrite, Anvil, score=0.477]
  Why it is non-obvious: Role alignment is stronger than lexical overlap.
  Why it still matters: Porting counterfit/reporting/image.py would strengthen artifact_output, reporting and deliver reporting_gain.
- counterfit/core/core.py -> Saguaro/saguaro/native/runtime/arch.py [disparate_mechanism_candidate, native_rewrite, Saguaro, score=0.476]
  Why it is non-obvious: Role alignment is stronger than lexical overlap.
  Why it still matters: Porting counterfit/core/core.py would strengthen mechanism and deliver capability_gain.
- counterfit/core/logger.py -> Saguaro/saguaro/native/runtime/arch.py [disparate_mechanism_candidate, native_rewrite, Saguaro, score=0.473]
  Why it is non-obvious: Role alignment is stronger than lexical overlap.
  Why it still matters: Porting counterfit/core/logger.py would strengthen mechanism and deliver capability_gain.
- counterfit/core/options.py -> Saguaro/saguaro/native/runtime/arch.py [disparate_mechanism_candidate, native_rewrite, Saguaro, score=0.470]
  Why it is non-obvious: Role alignment is stronger than lexical overlap.
  Why it still matters: Porting counterfit/core/options.py would strengthen mechanism and deliver capability_gain.
