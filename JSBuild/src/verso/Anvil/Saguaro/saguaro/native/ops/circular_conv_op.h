// saguaro.native/ops/circular_conv_op.h
...
#ifndef SAGUARO_NATIVE_OPS_CIRCULAR_CONV_OP_H_
#define SAGUARO_NATIVE_OPS_CIRCULAR_CONV_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_CIRCULAR_CONV_OP_H_
