// saguaro.native/ops/fused_state_bus_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_STATE_BUS_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_STATE_BUS_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_STATE_BUS_OP_H_
