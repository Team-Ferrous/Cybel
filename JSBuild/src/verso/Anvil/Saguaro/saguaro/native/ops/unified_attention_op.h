// saguaro.native/ops/unified_attention_op.h
...
#ifndef SAGUARO_NATIVE_OPS_UNIFIED_ATTENTION_OP_H_
#define SAGUARO_NATIVE_OPS_UNIFIED_ATTENTION_OP_H_
...
inline void softmax_inplace(float* data, int64_t size, float eps = 1e-6f) {
    ...
    // Step 3: Apply exp (use saguaro::ops::simd_exp_inplace from hnn_simd_common.h)
    saguaro::ops::simd_exp_inplace(data, size);
...
#endif  // SAGUARO_NATIVE_OPS_UNIFIED_ATTENTION_OP_H_
