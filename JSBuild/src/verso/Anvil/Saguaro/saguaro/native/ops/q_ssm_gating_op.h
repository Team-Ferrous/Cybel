// saguaro.native/ops/q_ssm_gating_op.h
...
#ifndef SAGUARO_NATIVE_OPS_Q_SSM_GATING_OP_H_
#define SAGUARO_NATIVE_OPS_Q_SSM_GATING_OP_H_
...
inline void QSSMForward(
    ...
    for (int t = 0; t < seq_len; ++t) {
        ...
        if (t + 1 < seq_len) {
            ...
            saguaro::ops::PrefetchT0(next_input);
            saguaro::ops::PrefetchT0(next_input + 64);  // Prefetch 2 cache lines
        }
        ...
        for (int b = 0; b < batch_size; ++b) {
            ...
            if (b + 1 < batch_size) {
                saguaro::ops::PrefetchT0(state + (b + 1) * config.state_dim);
            }
...
#endif  // SAGUARO_NATIVE_OPS_Q_SSM_GATING_OP_H_
