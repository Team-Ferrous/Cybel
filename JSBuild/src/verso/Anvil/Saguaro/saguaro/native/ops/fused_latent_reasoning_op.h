// saguaro.native/ops/fused_latent_reasoning_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_LATENT_REASONING_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_LATENT_REASONING_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_LATENT_REASONING_OP_H_
