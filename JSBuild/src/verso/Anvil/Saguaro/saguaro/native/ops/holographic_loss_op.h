// saguaro.native/ops/holographic_loss_op.h
...
#ifndef SAGUARO_NATIVE_OPS_HOLOGRAPHIC_LOSS_OP_H_
#define SAGUARO_NATIVE_OPS_HOLOGRAPHIC_LOSS_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_HOLOGRAPHIC_LOSS_OP_H_
