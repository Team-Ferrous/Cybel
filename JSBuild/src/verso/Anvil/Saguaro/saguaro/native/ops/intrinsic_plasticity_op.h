// saguaro.native/ops/intrinsic_plasticity_op.h
...
#ifndef SAGUARO_NATIVE_OPS_INTRINSIC_PLASTICITY_OP_H_
#define SAGUARO_NATIVE_OPS_INTRINSIC_PLASTICITY_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_INTRINSIC_PLASTICITY_OP_H_
