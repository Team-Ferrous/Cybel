# saguaro.native/ops/quantum_ops.py
...
with contextlib.suppress(KeyError):
    tf.RegisterGradient("UnitaryResidualForward")(_unitary_residual_forward_grad)
...
with contextlib.suppress(KeyError):
    tf.RegisterGradient("UnitaryNormForward")(_unitary_norm_forward_grad)
...
with contextlib.suppress(KeyError):
    tf.RegisterGradient("UnitaryExpertForward")(_unitary_expert_forward_grad)
...
with contextlib.suppress(KeyError):
    tf.RegisterGradient("QuantumEmbeddingForward")(_quantum_embedding_forward_grad)
...
with contextlib.suppress(KeyError):
    tf.RegisterGradient("FloquetPositionEncodingForward")(
        _floquet_position_encoding_forward_grad
    )
...
with contextlib.suppress(KeyError):
    tf.RegisterGradient("QuantumLMHeadForward")(_quantum_lm_head_forward_grad)
