# saguaro.native/ops/fused_mamba_op.py
...
Usage:
    from saguaro.native.ops.fused_mamba_op import fused_mamba_core
...
def fused_mamba_core(
    ...
    if _fused_mamba_core_op is None:
        raise RuntimeError(
            ...
            "Build the native library with: cd saguaro.native && ./build_secure.sh"
        )
