// saguaro.native/ops/fused_sliding_gqa_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_SLIDING_GQA_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_SLIDING_GQA_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_SLIDING_GQA_OP_H_
