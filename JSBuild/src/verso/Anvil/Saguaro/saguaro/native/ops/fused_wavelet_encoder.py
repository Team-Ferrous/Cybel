# saguaro.native/ops/fused_wavelet_encoder.py
...
try:
    ...
    fused_wavelet_encoder_chunk_op = getattr(
        ...
        getattr(_fused_wavelet_module, "FusedWaveletEncoderChunk", None),
    )
    fused_wavelet_encoder_chunk_grad_op = getattr(
        _fused_wavelet_module,
        "fused_wavelet_encoder_chunk_grad",
        getattr(_fused_wavelet_module, "FusedWaveletEncoderChunkGrad", None),
    )
    if fused_wavelet_encoder_chunk_op is not None:
