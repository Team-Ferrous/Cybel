// saguaro.native/ops/simd_circular_conv.h
...
#ifndef SAGUARO_NATIVE_OPS_SIMD_CIRCULAR_CONV_H_
#define SAGUARO_NATIVE_OPS_SIMD_CIRCULAR_CONV_H_
...
#endif  // SAGUARO_NATIVE_OPS_SIMD_CIRCULAR_CONV_H_
