// saguaro.native/ops/lmwt_attention_op.h
...
#ifndef SAGUARO_NATIVE_OPS_LMWT_ATTENTION_OP_H_
#define SAGUARO_NATIVE_OPS_LMWT_ATTENTION_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_LMWT_ATTENTION_OP_H_
