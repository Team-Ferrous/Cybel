# saguaro.native/ops/fused_wlam_op.py
...
def fused_wlam(
    ...
    predict_w:         None = None,
    update_w:          None = None,
    scatter_filter:    None = None,
    cross_attn_q:      None = None,
    cross_attn_k:      None = None,
    cross_attn_v:      None = None,
    cross_attn_o:      None = None,
    num_levels:        int = 1,
    ...
    if _fused_wlam_op is None:
        raise RuntimeError(
            ...
            "cd saguaro.native && ./build_ops.sh"
        )
