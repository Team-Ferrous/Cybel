// saguaro.native/ops/hd_streaming_adapter_op.h
...
#ifndef SAGUARO_NATIVE_OPS_HD_STREAMING_ADAPTER_OP_H_
#define SAGUARO_NATIVE_OPS_HD_STREAMING_ADAPTER_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_HD_STREAMING_ADAPTER_OP_H_
