// saguaro.native/ops/self_consistency_filter.h
...
#ifndef SAGUARO_NATIVE_OPS_SELF_CONSISTENCY_FILTER_H_
#define SAGUARO_NATIVE_OPS_SELF_CONSISTENCY_FILTER_H_
...
#endif  // SAGUARO_NATIVE_OPS_SELF_CONSISTENCY_FILTER_H_
