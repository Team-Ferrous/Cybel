# saguaro.native/ops/quantum_galore_ops.py
...
Example:
    >>> from saguaro.native.ops.quantum_galore_ops import quantum_galore_project
...
try:
    from saguaro.native import _load_consolidated_binary, is_consolidated_available
