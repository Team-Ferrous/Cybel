// saguaro.native/ops/quantum_coherence_bus_op.h
...
#ifndef SAGUARO_NATIVE_OPS_QUANTUM_COHERENCE_BUS_OP_H_
#define SAGUARO_NATIVE_OPS_QUANTUM_COHERENCE_BUS_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_QUANTUM_COHERENCE_BUS_OP_H_
