// saguaro.native/ops/fused_tpa_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_TPA_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_TPA_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_TPA_OP_H_
