// saguaro.native/ops/memory_builder_enhancements.h
...
#ifndef SAGUARO_NATIVE_OPS_MEMORY_BUILDER_ENHANCEMENTS_H_
#define SAGUARO_NATIVE_OPS_MEMORY_BUILDER_ENHANCEMENTS_H_
...
#endif  // SAGUARO_NATIVE_OPS_MEMORY_BUILDER_ENHANCEMENTS_H_
