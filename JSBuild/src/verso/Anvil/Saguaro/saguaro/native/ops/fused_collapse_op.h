// saguaro.native/ops/fused_collapse_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_COLLAPSE_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_COLLAPSE_OP_H_
...
#include <immintrin.h>
#define SAGUARO_COLLAPSE_SIMD_AVX512 1
#define SAGUARO_COLLAPSE_SIMD_WIDTH 16
#elif defined(__AVX2__)
#include <immintrin.h>
#define SAGUARO_COLLAPSE_SIMD_AVX2 1
#define SAGUARO_COLLAPSE_SIMD_WIDTH 8
#elif defined(__ARM_NEON)
#include <arm_neon.h>
#define SAGUARO_COLLAPSE_SIMD_NEON 1
#define SAGUARO_COLLAPSE_SIMD_WIDTH 4
#else
#define SAGUARO_COLLAPSE_SIMD_SCALAR 1
#define SAGUARO_COLLAPSE_SIMD_WIDTH 1
#endif
...
#if defined(SAGUARO_COLLAPSE_SIMD_AVX512)
...
#elif defined(SAGUARO_COLLAPSE_SIMD_AVX2)
    if (std::is_same<T, float>::value) {
...
#elif defined(SAGUARO_COLLAPSE_SIMD_NEON)
    if (std::is_same<T, float>::value) {
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_COLLAPSE_OP_H_
