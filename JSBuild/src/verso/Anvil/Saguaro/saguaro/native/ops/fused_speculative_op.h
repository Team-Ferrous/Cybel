// saguaro.native/ops/fused_speculative_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_SPECULATIVE_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_SPECULATIVE_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_SPECULATIVE_OP_H_
