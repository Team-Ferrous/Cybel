// saguaro.native/ops/quantum_training_config.h
...
#ifndef SAGUARO_NATIVE_OPS_QUANTUM_TRAINING_CONFIG_H_
#define SAGUARO_NATIVE_OPS_QUANTUM_TRAINING_CONFIG_H_
...
#endif  // SAGUARO_NATIVE_OPS_QUANTUM_TRAINING_CONFIG_H_
