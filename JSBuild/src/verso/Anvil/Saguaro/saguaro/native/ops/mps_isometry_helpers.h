// saguaro.native/ops/mps_isometry_helpers.h
...
#ifndef SAGUARO_NATIVE_OPS_MPS_ISOMETRY_HELPERS_H_
#define SAGUARO_NATIVE_OPS_MPS_ISOMETRY_HELPERS_H_
...
#endif  // SAGUARO_NATIVE_OPS_MPS_ISOMETRY_HELPERS_H_
