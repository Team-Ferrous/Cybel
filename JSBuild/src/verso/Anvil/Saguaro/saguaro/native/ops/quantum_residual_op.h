// saguaro.native/ops/quantum_residual_op.h
...
#ifndef SAGUARO_NATIVE_OPS_QUANTUM_RESIDUAL_OP_H_
#define SAGUARO_NATIVE_OPS_QUANTUM_RESIDUAL_OP_H_
...
#include <immintrin.h>
#define SAGUARO_QRES_AVX512 1
#define SAGUARO_QRES_SIMD_WIDTH 16
#elif defined(__AVX2__)
#include <immintrin.h>
#define SAGUARO_QRES_AVX2 1
#define SAGUARO_QRES_SIMD_WIDTH 8
#elif defined(__ARM_NEON)
#include <arm_neon.h>
#define SAGUARO_QRES_NEON 1
#define SAGUARO_QRES_SIMD_WIDTH 4
#else
#define SAGUARO_QRES_SCALAR 1
#define SAGUARO_QRES_SIMD_WIDTH 1
#endif
...
#if defined(SAGUARO_QRES_AVX512)
...
#elif defined(SAGUARO_QRES_AVX2)
...
#elif defined(SAGUARO_QRES_NEON)
...
#endif  // SAGUARO_NATIVE_OPS_QUANTUM_RESIDUAL_OP_H_
