// saguaro.native/ops/fused_parallel_scan_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_PARALLEL_SCAN_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_PARALLEL_SCAN_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_PARALLEL_SCAN_OP_H_
