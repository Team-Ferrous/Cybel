// saguaro.native/ops/fused_mod_routing_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_MOD_ROUTING_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_MOD_ROUTING_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_MOD_ROUTING_OP_H_
