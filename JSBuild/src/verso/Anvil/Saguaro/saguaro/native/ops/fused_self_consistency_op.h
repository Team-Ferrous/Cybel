// saguaro.native/ops/fused_self_consistency_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_SELF_CONSISTENCY_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_SELF_CONSISTENCY_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_SELF_CONSISTENCY_OP_H_
