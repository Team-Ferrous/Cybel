// saguaro.native/ops/mps_memory_compressor.h
...
#ifndef SAGUARO_NATIVE_OPS_MPS_MEMORY_COMPRESSOR_H_
#define SAGUARO_NATIVE_OPS_MPS_MEMORY_COMPRESSOR_H_
...
#endif  // SAGUARO_NATIVE_OPS_MPS_MEMORY_COMPRESSOR_H_
