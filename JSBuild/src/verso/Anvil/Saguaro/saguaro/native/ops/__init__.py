# saguaro.native/ops/__init__.py
...
from saguaro.native.ops.alphaqubit_ops import (
    alphaqubit_decode,
    create_alphaqubit_weights,
)
from saguaro.native.ops.alphaqubit_ops import ops_available as alphaqubit_ops_available

# Phase 45: Entropy Regularization
from saguaro.native.ops.entropy_regularization_ops import (
...
from saguaro.native.ops.fused_qwt_tokenizer import (
    fused_qwt_tokenizer,
...
from saguaro.native.ops.fused_wavelet_encoder import (
    fused_wavelet_encoder_available,
    fused_wavelet_encoder_chunk,
)

# Phase 200+: HD Streaming Adapter
from saguaro.native.ops.hd_streaming_adapter import (
    HDStreamingAdapter,
...
from saguaro.native.ops.intrinsic_plasticity_ops import (
...
try:
    from saguaro.native.ops.tensor_stream_pool import (
        StreamingBuffer,
...
from saguaro.native.ops.fused_quls_loss_op import (
    fused_quls_loss,
...
from saguaro.native.ops.mps_contract import mps_contract
from saguaro.native.ops.mps_temporal import mps_temporal_scan

# Native optimizers (including Phase 46, 59, 60)
from saguaro.native.ops.optimizers import (  # Phase 59: Adiabatic; Phase 60: Geodesic; Phase 46: SympFlow
...
from saguaro.native.ops.quantum_advanced_ops import (
    compute_coherence,
    nqs_decoder,
    qcot_reason,
    waveform_attention,
...
from saguaro.native.ops.quantum_coherence_bus_ops import (
...
from saguaro.native.ops.quantum_crystallization_ops import (
    crystallize_memory,
...
from saguaro.native.ops.quantum_dropout_ops import (
    entangling_dropout,
...
from saguaro.native.ops.quantum_ops import (  # Phase 34: Unitary Residual; Phase 30: Quantum Norm; Phase 29: Unitary Expert; Phase 26: Quantum Embedding; Phase 27: Floquet Position; Phase 33: Quantum LM Head; Phase 32: Grover QSG; Phase 51: Born Rule Loss; Phase 52: Quantum Fidelity Loss
    born_rule_loss,
...
from saguaro.native.ops.quantum_teleport_bus_ops import (
    bell_measurement,
...
from saguaro.native.ops.selective_scan_op import (
...
from saguaro.native.ops.specialized_quantum_ops import (
...
from saguaro.native.ops.train_step import (
    fused_train_step,
...
from saguaro.native.ops.vqem_ops import (
    create_vqem_params,
    vqem_forward,
    vqem_train_step,
)
from saguaro.native.ops.vqem_ops import ops_available as vqem_ops_available
