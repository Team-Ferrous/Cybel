// saguaro.native/ops/hd_thought_trace_op.h
...
#ifndef SAGUARO_NATIVE_OPS_HD_THOUGHT_TRACE_OP_H_
#define SAGUARO_NATIVE_OPS_HD_THOUGHT_TRACE_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_HD_THOUGHT_TRACE_OP_H_
