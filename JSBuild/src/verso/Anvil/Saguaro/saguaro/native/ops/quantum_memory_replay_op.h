// saguaro.native/ops/quantum_memory_replay_op.h
...
#ifndef SAGUARO_NATIVE_OPS_QUANTUM_MEMORY_REPLAY_OP_H_
#define SAGUARO_NATIVE_OPS_QUANTUM_MEMORY_REPLAY_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_QUANTUM_MEMORY_REPLAY_OP_H_
