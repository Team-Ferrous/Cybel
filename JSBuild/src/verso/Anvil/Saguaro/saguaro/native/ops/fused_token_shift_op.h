// saguaro.native/ops/fused_token_shift_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_TOKEN_SHIFT_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_TOKEN_SHIFT_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_TOKEN_SHIFT_OP_H_
