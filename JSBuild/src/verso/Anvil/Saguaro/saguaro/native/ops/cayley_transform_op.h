// saguaro.native/ops/cayley_transform_op.h
...
#ifndef SAGUARO_NATIVE_OPS_CAYLEY_TRANSFORM_OP_H_
#define SAGUARO_NATIVE_OPS_CAYLEY_TRANSFORM_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_CAYLEY_TRANSFORM_OP_H_
