// saguaro.native/ops/quantum_foundation_ops.h
...
#ifndef SAGUARO_NATIVE_OPS_QUANTUM_FOUNDATION_OPS_H_
#define SAGUARO_NATIVE_OPS_QUANTUM_FOUNDATION_OPS_H_
 ...
 */
inline void UnifiedQuantumForward(
    const float* input,
    const float* params,
    float* output,
    ...
    switch (config.op_type) {
        case QuantumOpType::VQC:
            VQCForward(input, params, output, config);
            break;
            
        case QuantumOpType::TENSOR_RING_VQC:
            TensorRingVQCForward(input, params, output, config);
            break;
            
        case QuantumOpType::LM_HEAD:
            QuantumLMHeadForward(input, params, aux_input, output, config);
            break;
            
        case QuantumOpType::EXPERT:
            QuantumExpertForward(input, params, output, config);
            break;
            
        case QuantumOpType::NORM:
            QuantumNormForward(input, params, aux_input, output, config);
            break;
            
        case QuantumOpType::DROPOUT:
            QuantumDropoutForward(input, output, training, 0, config);
            break;
            
        case QuantumOpType::MEASUREMENT:
            QuantumMeasurementForward(input, output, nullptr, config);
            break;
            
        case QuantumOpType::CRYSTALLIZATION:
            QuantumCrystallizationForward(input, output, nullptr, config);
            break;
            
        case QuantumOpType::CURRICULUM:
            QuantumCurriculumScore(input, output, config);
            break;
...
#endif  // SAGUARO_NATIVE_OPS_QUANTUM_FOUNDATION_OPS_H_
