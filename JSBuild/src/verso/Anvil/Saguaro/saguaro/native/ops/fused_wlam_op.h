// saguaro.native/ops/fused_wlam_op.h
...
#ifndef SAGUARO_NATIVE_OPS_FUSED_WLAM_OP_H_
#define SAGUARO_NATIVE_OPS_FUSED_WLAM_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_FUSED_WLAM_OP_H_
