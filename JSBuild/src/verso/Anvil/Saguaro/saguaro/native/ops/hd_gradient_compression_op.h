// saguaro.native/ops/hd_gradient_compression_op.h
...
#ifndef SAGUARO_NATIVE_OPS_HD_GRADIENT_COMPRESSION_OP_H_
#define SAGUARO_NATIVE_OPS_HD_GRADIENT_COMPRESSION_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_HD_GRADIENT_COMPRESSION_OP_H_
