// saguaro.native/ops/qwt_continuous_op.h
...
#ifndef SAGUARO_NATIVE_OPS_QWT_CONTINUOUS_OP_H_
#define SAGUARO_NATIVE_OPS_QWT_CONTINUOUS_OP_H_
...
#endif  // SAGUARO_NATIVE_OPS_QWT_CONTINUOUS_OP_H_
