...
class ChronicleStorage:
    """Provide ChronicleStorage support."""
    def __init__(self, db_path: str = ".saguaro/chronicle.db") -> None:
    ...
    def list_snapshots(self) -> list[dict[str, Any]]:
        ...
        with self.get_connection() as conn:
            ...
            cursor = conn.cursor()
            cursor.execute(
                "SELECT id, timestamp, commit_hash, description FROM snapshots ORDER BY timestamp DESC"
            )
