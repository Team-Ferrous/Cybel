...
class SAGUAROClient:
    """Provide SAGUAROClient support."""
    def __init__(self, repo_path: str = ".", saguaro_cmd: str = "saguaro") -> None:
    ...
    def start(self) -> None:
        ...
        try:
            # Relies on 'saguaro' being on PATH (global install) or an
            # explicit path passed via saguaro_cmd.  See
            # saguaro.utils.file_utils.resolve_saguaro_cmd for dynamic
            # resolution when constructing the cmd externally.
