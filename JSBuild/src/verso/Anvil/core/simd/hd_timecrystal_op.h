// highnoon/_native/ops/hd_timecrystal_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_TIMECRYSTAL_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_TIMECRYSTAL_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_TIMECRYSTAL_OP_H_
