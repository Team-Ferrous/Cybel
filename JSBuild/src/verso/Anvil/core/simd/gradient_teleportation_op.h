// highnoon/_native/ops/gradient_teleportation_op.h
// Copyright 2025 Verso Industries (Author: Michael B. Zimmerman)
/**
 * @file gradient_teleportation_op.h
 * @brief Phase 64: Gradient Teleportation for distributed training
 */
#ifndef HIGHNOON_NATIVE_OPS_GRADIENT_TELEPORTATION_OP_H_
#define HIGHNOON_NATIVE_OPS_GRADIENT_TELEPORTATION_OP_H_
#include <cmath>
#include <vector>
