// highnoon/_native/ops/fused_superposition_slots_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_FUSED_SUPERPOSITION_SLOTS_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_SUPERPOSITION_SLOTS_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_FUSED_SUPERPOSITION_SLOTS_OP_H_
