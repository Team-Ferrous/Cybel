// highnoon/_native/ops/coconut_reservoir_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_COCONUT_RESERVOIR_OP_H_
#define HIGHNOON_NATIVE_OPS_COCONUT_RESERVOIR_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_COCONUT_RESERVOIR_OP_H_
