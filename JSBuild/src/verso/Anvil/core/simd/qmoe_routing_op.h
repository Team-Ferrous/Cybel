// highnoon/_native/ops/qmoe_routing_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_QMOE_ROUTING_OP_H_
#define HIGHNOON_NATIVE_OPS_QMOE_ROUTING_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_QMOE_ROUTING_OP_H_
