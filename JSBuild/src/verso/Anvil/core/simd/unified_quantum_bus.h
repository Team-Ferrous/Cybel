// highnoon/_native/ops/unified_quantum_bus.h
...
#ifndef HIGHNOON_NATIVE_OPS_UNIFIED_QUANTUM_BUS_H_
#define HIGHNOON_NATIVE_OPS_UNIFIED_QUANTUM_BUS_H_
...
#endif // HIGHNOON_NATIVE_OPS_UNIFIED_QUANTUM_BUS_H_
