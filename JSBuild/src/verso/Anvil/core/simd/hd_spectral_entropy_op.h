// highnoon/_native/ops/hd_spectral_entropy_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_SPECTRAL_ENTROPY_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_SPECTRAL_ENTROPY_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_SPECTRAL_ENTROPY_OP_H_
