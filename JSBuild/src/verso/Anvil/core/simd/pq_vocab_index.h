// highnoon/_native/ops/pq_vocab_index.h
...
#ifndef HIGHNOON_NATIVE_OPS_PQ_VOCAB_INDEX_H_
#define HIGHNOON_NATIVE_OPS_PQ_VOCAB_INDEX_H_
...
#endif  // HIGHNOON_NATIVE_OPS_PQ_VOCAB_INDEX_H_
