// highnoon/_native/ops/fused_qwt_tokenizer_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_FUSED_QWT_TOKENIZER_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_QWT_TOKENIZER_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_FUSED_QWT_TOKENIZER_OP_H_
