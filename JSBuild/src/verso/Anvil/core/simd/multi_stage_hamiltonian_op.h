// highnoon/_native/ops/multi_stage_hamiltonian_op.h
// Copyright 2025 Verso Industries (Author: Michael B. Zimmerman)
/**
 * @file multi_stage_hamiltonian_op.h
 * @brief Phase 70: Multi-Stage Hamiltonian Learning
 */
#ifndef HIGHNOON_NATIVE_OPS_MULTI_STAGE_HAMILTONIAN_OP_H_
#define HIGHNOON_NATIVE_OPS_MULTI_STAGE_HAMILTONIAN_OP_H_
#include <cmath>
#include <vector>
