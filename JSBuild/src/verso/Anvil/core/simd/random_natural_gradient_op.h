// highnoon/_native/ops/random_natural_gradient_op.h
// Copyright 2025 Verso Industries (Author: Michael B. Zimmerman)
/**
 * @file random_natural_gradient_op.h
 * @brief Phase 72: Random Natural Gradient (RNG) for efficient QNG approximation
 */
#ifndef HIGHNOON_NATIVE_OPS_RANDOM_NATURAL_GRADIENT_OP_H_
#define HIGHNOON_NATIVE_OPS_RANDOM_NATURAL_GRADIENT_OP_H_
#include <cmath>
#include <vector>
#include <random>
