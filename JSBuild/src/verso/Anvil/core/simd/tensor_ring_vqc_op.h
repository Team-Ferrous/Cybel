// highnoon/_native/ops/tensor_ring_vqc_op.h
...
#ifndef HIGHNOON_OPS_TENSOR_RING_VQC_OP_H_
#define HIGHNOON_OPS_TENSOR_RING_VQC_OP_H_
...
#endif  // HIGHNOON_OPS_TENSOR_RING_VQC_OP_H_
