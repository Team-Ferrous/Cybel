// highnoon/_native/ops/quantum_teleport_bus_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_QUANTUM_TELEPORT_BUS_OP_H_
#define HIGHNOON_NATIVE_OPS_QUANTUM_TELEPORT_BUS_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_QUANTUM_TELEPORT_BUS_OP_H_
