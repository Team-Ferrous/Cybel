// highnoon/_native/ops/entropy_regularization_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_ENTROPY_REGULARIZATION_OP_H_
#define HIGHNOON_NATIVE_OPS_ENTROPY_REGULARIZATION_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_ENTROPY_REGULARIZATION_OP_H_
