// highnoon/_native/ops/fused_continuous_thought_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_FUSED_CONTINUOUS_THOUGHT_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_CONTINUOUS_THOUGHT_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_FUSED_CONTINUOUS_THOUGHT_OP_H_
