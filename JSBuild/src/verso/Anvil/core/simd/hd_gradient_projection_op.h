// highnoon/_native/ops/hd_gradient_projection_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_GRADIENT_PROJECTION_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_GRADIENT_PROJECTION_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_GRADIENT_PROJECTION_OP_H_
