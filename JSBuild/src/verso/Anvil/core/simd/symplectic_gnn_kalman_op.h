// highnoon/_native/ops/symplectic_gnn_kalman_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_SYMPLECTIC_GNN_KALMAN_OP_H_
#define HIGHNOON_NATIVE_OPS_SYMPLECTIC_GNN_KALMAN_OP_H_
