// highnoon/_native/ops/fused_fft_projector_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_FUSED_FFT_PROJECTOR_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_FFT_PROJECTOR_OP_H_
...
#endif // HIGHNOON_NATIVE_OPS_FUSED_FFT_PROJECTOR_OP_H_
