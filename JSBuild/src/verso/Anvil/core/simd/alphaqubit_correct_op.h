// highnoon/_native/ops/alphaqubit_correct_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_ALPHAQUBIT_CORRECT_OP_H_
#define HIGHNOON_NATIVE_OPS_ALPHAQUBIT_CORRECT_OP_H_
