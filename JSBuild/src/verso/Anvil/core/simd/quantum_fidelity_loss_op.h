// highnoon/_native/ops/quantum_fidelity_loss_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_QUANTUM_FIDELITY_LOSS_OP_H_
#define HIGHNOON_NATIVE_OPS_QUANTUM_FIDELITY_LOSS_OP_H_
