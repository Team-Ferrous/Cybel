// highnoon/_native/ops/discrete_time_crystal_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_DISCRETE_TIME_CRYSTAL_OP_H_
#define HIGHNOON_NATIVE_OPS_DISCRETE_TIME_CRYSTAL_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_DISCRETE_TIME_CRYSTAL_OP_H_
