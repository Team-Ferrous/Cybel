// highnoon/_native/ops/simd_tucker_contract.h
...
#ifndef HIGHNOON_NATIVE_OPS_SIMD_TUCKER_CONTRACT_H_
#define HIGHNOON_NATIVE_OPS_SIMD_TUCKER_CONTRACT_H_
...
#endif  // HIGHNOON_NATIVE_OPS_SIMD_TUCKER_CONTRACT_H_
