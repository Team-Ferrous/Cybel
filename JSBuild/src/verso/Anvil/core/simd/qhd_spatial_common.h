// highnoon/_native/ops/qhd_spatial_common.h
#ifndef HIGHNOON_NATIVE_OPS_QHD_SPATIAL_COMMON_H_
#define HIGHNOON_NATIVE_OPS_QHD_SPATIAL_COMMON_H_
...
#endif // HIGHNOON_NATIVE_OPS_QHD_SPATIAL_COMMON_H_
