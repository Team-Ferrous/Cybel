// highnoon/_native/ops/fused_linear_gqa_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_FUSED_LINEAR_GQA_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_LINEAR_GQA_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_FUSED_LINEAR_GQA_OP_H_
