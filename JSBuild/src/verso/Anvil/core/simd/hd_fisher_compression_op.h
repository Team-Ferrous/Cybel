// highnoon/_native/ops/hd_fisher_compression_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_FISHER_COMPRESSION_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_FISHER_COMPRESSION_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_FISHER_COMPRESSION_OP_H_
