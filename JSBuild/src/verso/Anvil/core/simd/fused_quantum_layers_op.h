// highnoon/_native/ops/fused_quantum_layers_op.h
// Quantum layer SIMD helpers - VQC expectation value helpers

#ifndef HIGHNOON_NATIVE_OPS_FUSED_QUANTUM_LAYERS_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_QUANTUM_LAYERS_OP_H_
