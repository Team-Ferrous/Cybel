// highnoon/_native/ops/sympflow_optimizer_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_SYMPFLOW_OPTIMIZER_OP_H_
#define HIGHNOON_NATIVE_OPS_SYMPFLOW_OPTIMIZER_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_SYMPFLOW_OPTIMIZER_OP_H_
