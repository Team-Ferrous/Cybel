// highnoon/_native/ops/entanglement_loss.h
...
#ifndef HIGHNOON_NATIVE_OPS_ENTANGLEMENT_LOSS_H_
#define HIGHNOON_NATIVE_OPS_ENTANGLEMENT_LOSS_H_
...
#endif  // HIGHNOON_NATIVE_OPS_ENTANGLEMENT_LOSS_H_
