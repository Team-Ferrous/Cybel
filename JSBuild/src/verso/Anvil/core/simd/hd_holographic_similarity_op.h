// highnoon/_native/ops/hd_holographic_similarity_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_HOLOGRAPHIC_SIMILARITY_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_HOLOGRAPHIC_SIMILARITY_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_HOLOGRAPHIC_SIMILARITY_OP_H_
