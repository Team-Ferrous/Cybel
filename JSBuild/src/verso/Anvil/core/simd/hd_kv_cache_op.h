// highnoon/_native/ops/hd_kv_cache_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_KV_CACHE_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_KV_CACHE_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_KV_CACHE_OP_H_
