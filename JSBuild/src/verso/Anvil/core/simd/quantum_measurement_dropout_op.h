// highnoon/_native/ops/quantum_measurement_dropout_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_QUANTUM_MEASUREMENT_DROPOUT_OP_H_
#define HIGHNOON_NATIVE_OPS_QUANTUM_MEASUREMENT_DROPOUT_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_QUANTUM_MEASUREMENT_DROPOUT_OP_H_
