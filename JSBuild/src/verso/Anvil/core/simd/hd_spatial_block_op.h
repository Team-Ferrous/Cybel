// highnoon/_native/ops/hd_spatial_block_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_SPATIAL_BLOCK_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_SPATIAL_BLOCK_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_SPATIAL_BLOCK_OP_H_
