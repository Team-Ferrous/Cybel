// highnoon/_native/ops/mps_tensor_ops.h
...
#ifndef HIGHNOON_NATIVE_OPS_MPS_TENSOR_OPS_H_
#define HIGHNOON_NATIVE_OPS_MPS_TENSOR_OPS_H_
...
#endif  // HIGHNOON_NATIVE_OPS_MPS_TENSOR_OPS_H_
