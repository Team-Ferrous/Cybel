// highnoon/_native/ops/vocab_factorization.h
...
#ifndef HIGHNOON_NATIVE_OPS_VOCAB_FACTORIZATION_H_
#define HIGHNOON_NATIVE_OPS_VOCAB_FACTORIZATION_H_
...
#endif  // HIGHNOON_NATIVE_OPS_VOCAB_FACTORIZATION_H_
