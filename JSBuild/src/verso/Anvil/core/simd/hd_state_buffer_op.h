// highnoon/_native/ops/hd_state_buffer_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_HD_STATE_BUFFER_OP_H_
#define HIGHNOON_NATIVE_OPS_HD_STATE_BUFFER_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_HD_STATE_BUFFER_OP_H_
