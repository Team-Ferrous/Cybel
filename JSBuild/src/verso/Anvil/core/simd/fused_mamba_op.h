// highnoon/_native/ops/fused_mamba_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_FUSED_MAMBA_OP_H_
#define HIGHNOON_NATIVE_OPS_FUSED_MAMBA_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_FUSED_MAMBA_OP_H_
