// highnoon/_native/ops/tt_floquet_decomposition.h
...
#ifndef HIGHNOON_NATIVE_OPS_TT_FLOQUET_DECOMPOSITION_H_
#define HIGHNOON_NATIVE_OPS_TT_FLOQUET_DECOMPOSITION_H_
...
#endif  // HIGHNOON_NATIVE_OPS_TT_FLOQUET_DECOMPOSITION_H_
