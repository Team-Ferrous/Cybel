// highnoon/_native/ops/neural_kalman_op.h
...
#ifndef HIGHNOON_NATIVE_OPS_NEURAL_KALMAN_OP_H_
#define HIGHNOON_NATIVE_OPS_NEURAL_KALMAN_OP_H_
...
#endif  // HIGHNOON_NATIVE_OPS_NEURAL_KALMAN_OP_H_
