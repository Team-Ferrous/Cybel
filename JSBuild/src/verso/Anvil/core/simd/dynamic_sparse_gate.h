// highnoon/_native/ops/dynamic_sparse_gate.h
...
#ifndef HIGHNOON_NATIVE_OPS_DYNAMIC_SPARSE_GATE_H_
#define HIGHNOON_NATIVE_OPS_DYNAMIC_SPARSE_GATE_H_
...
#endif  // HIGHNOON_NATIVE_OPS_DYNAMIC_SPARSE_GATE_H_
