// highnoon/_native/ops/quantum_gate_modulator.h
...
#ifndef HIGHNOON_NATIVE_OPS_QUANTUM_GATE_MODULATOR_H_
#define HIGHNOON_NATIVE_OPS_QUANTUM_GATE_MODULATOR_H_
...
#endif  // HIGHNOON_NATIVE_OPS_QUANTUM_GATE_MODULATOR_H_
